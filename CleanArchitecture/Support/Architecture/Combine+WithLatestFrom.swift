...
extension Publishers {
    ...
    public struct WithLatestFrom<Upstream: Publisher, Other: Publisher, Output>: Publisher where Upstream.Failure == Other.Failure {
        public typealias Failure = Upstream.Failure  // swiftlint:disable:this nesting
        public typealias ResultSelector = (Upstream.Output, Other.Output) -> Output  // swiftlint:disable:this nesting
